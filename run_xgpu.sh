...
#
#CUDA_VISIBLE_DEVICES=9 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/109duoelevator_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=8 python train_3dvid.py \
...
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1017cuhktree_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=1 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1017dorm1_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=2 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1017dorm2_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=3 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1017hair1_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=4 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1017palm_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=5 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1017palmbg_mpvgpnn.txt &




#CUDA_VISIBLE_DEVICES=0 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1017potflower_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=1 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1017roadside_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=2 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1017ustspring_mpvgpnn.txt &
#
CUDA_VISIBLE_DEVICES=3 python train_3dvid.py \
  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1017yuanrm_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=4 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1017yuanwild_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=5 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1020hydrant_mpvgpnn.txt &
#



#CUDA_VISIBLE_DEVICES=0 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1020playground_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=1 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1020rock_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=2 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1020rockrm_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=3 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1020ustfall1_mpvgpnn.txt &
#
#CUDA_VISIBLE_DEVICES=4 python train_3dvid.py \
#  --config configs/mpvgpnn_shared.txt --config1 configs/mpvgpnn_final_largep/1020ustfall2_mpvgpnn.txt &
