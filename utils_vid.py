...
class Patch3DSWDLoss(torch.nn.Module):
    def __init__(self, patch_size=7, patcht_size=7, stride=1, num_proj=256, use_convs=True, mask_patches_factor=0,
                 roi_region_pct=0.02):
    ...
    def forward(self, x, y, mask=None):
        ...
        if self.use_convs:
            ...
            projy = F.conv3d(y, rand).reshape(self.num_proj, -1, ch * cw)
